...
```{r}
setwd("C:/workspace/Github/snu_edu/3 semester/Data Driven Marketing Analytics/clusterexample")
mydata = read_csv("Wholesale.csv")
```
...
fit$size
fit$centers # centriod를 주로 해석을 많이한다.
